...
class MyMovieList2 extends Component {
    state = {
        movies: [],
        isLoaded:false,
    }
    ...
    componentDidMount() {
        const ApiEndpoint = `http://www.omdbapi.com/?i=tt3896198&apikey=b7a71124&movies&s=$batman`;
        ...
        render() {
            ...
            return (
                <Container fluid className="px-5 mt-4">
                    <div>
                        <h2 className="text-white me-4">Batman</h2>
